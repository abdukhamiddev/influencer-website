...
const MenuOverlay = ({ navbarOpen, setNavbarOpen }) => {
	return (
		<nav
			className={` lg:hidden fixed flex top-0 left-0 w-full px-10 z-10 h-screen pt-24 bg-gradient-to-br from-purple-50 to-purple-300 transform delay-100 duration-300 ${
